  ...
  return (
    <div className="h-screen w-screen bg-[#050505] text-white font-sans selection:bg-white selection:text-black overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <nav className="flex justify-between items-center px-12 py-12 max-w-7xl mx-auto w-full">
          <div className="flex items-center gap-4 group cursor-default">
            <span className="text-2xl font-black tracking-[0.3em] uppercase transition-all group-hover:tracking-[0.4em]">
              Vyte <span className="font-thin text-zinc-500 italic">Factory</span>
            </span>
          </div>
          <Link
            href="/admin/login"
            className="px-8 py-3 rounded-full border border-white/10 bg-white/5 backdrop-blur-md hover:bg-white hover:text-black transition-all font-bold text-[10px] uppercase tracking-widest"
          >
            Acceso Clientes
          </Link>
        </nav>
        ...
        <main className="flex-grow flex flex-col items-center justify-center px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/5 bg-white/[0.02] text-zinc-500 text-[9px] font-bold uppercase tracking-[0.4em] mb-12">
          ...
          <p className="text-zinc-500 text-lg md:text-xl max-w-xl mx-auto mb-16 leading-relaxed font-light tracking-wide">
          ...
          <div className="flex items-center justify-center">
            <Link
              href="/admin/login"
              className="group flex items-center gap-4 text-xs font-black uppercase tracking-[0.5em] text-white hover:text-zinc-400 transition-all"
            >
